...
<div class="knowledge-card tools-card">
  ...
  <div class="knowledge-action">
    <a href="/AprenMaker-Hub/knowledge/tools/tools/" class="knowledge-link">Learn About Tools →</a>
  </div>
</div>

<div class="knowledge-card methodologies-card">
  <div class="knowledge-header">
    <div class="knowledge-icon">
      <svg viewBox="0 0 24 24" class="knowledge-icon-svg">
